//
//  OrderShipmentViewController.swift
//  EduTemplate
//
...
class OrderShipmentViewController: BaseViewController {
    ...
    override func viewDidLoad() {
        ...
        let title = UIBarButtonItem(image: #imageLiteral(resourceName: "주문배송"), style: .plain, target: self, action: #selector(dummy))
