...
protocol ClassCustomMenuBarDelegate: class {
    func customMenuBar(scrollTo index: Int)
}

class ClassCustomMenu: UIView {
    
    weak var delegate: ClassCustomMenuBarDelegate?
    ...
    func setupCollectioView(){
        ...
        // 상단 탭 바 등록
        customTabBarCollectionView.register(UINib(nibName: "ClassCustomCell01", bundle: nil), forCellWithReuseIdentifier: "ClassCustomCell01")
        
        customTabBarCollectionView.register(UINib(nibName: "ClassCustomCell02", bundle: nil), forCellWithReuseIdentifier: "ClassCustomCell02")
...
extension ClassCustomMenu: UICollectionViewDelegate, UICollectionViewDataSource {
    
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        
        switch indexPath.row {
        case 0:
            let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "ClassCustomCell01", for: indexPath) as! ClassCustomCell01
            return cell
        case 1:
            let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "ClassCustomCell02", for: indexPath) as! ClassCustomCell02
            return cell
        case 2:
...
extension ClassCustomMenu: UICollectionViewDelegateFlowLayout {
