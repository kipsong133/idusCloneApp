...
protocol CategoryCustomMenuBarDelegate: class {
    func customMenuBar(scrollTo index: Int)
}

class CategoryCustomMenu: UIView {
    
    weak var delegate: CategoryCustomMenuBarDelegate?
    ...
    func setupCollectioView(){
        ...
        // 상단 탭 바 등록
        customTabBarCollectionView.register(UINib(nibName: "CategoryCustomCell01", bundle: nil), forCellWithReuseIdentifier: "CategoryCustomCell01")
        
        customTabBarCollectionView.register(UINib(nibName: "CategoryCustomCell02", bundle: nil), forCellWithReuseIdentifier: "CategoryCustomCell02")
...
extension CategoryCustomMenu: UICollectionViewDelegate, UICollectionViewDataSource {
    
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        
        switch indexPath.row {
        case 0:
            let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "CategoryCustomCell01", for: indexPath) as! CategoryCustomCell01
            return cell
        case 1:
            let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "CategoryCustomCell02", for: indexPath) as! CategoryCustomCell02
            return cell
        case 2:
...
extension CategoryCustomMenu: UICollectionViewDelegateFlowLayout {
